  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Charger les clients
        const clientsResponse = await fetch('/api/admin/list-clients')
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">
              Créez et gérez les campagnes Google Ads pour vos clients
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Choisissez le client pour lequel créer ou gérer des campagnes
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ClientSelector
          ...
          <TabsContent value="campaigns" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Toutes les campagnes créées pour les clients
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="performance" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Métriques détaillées des campagnes
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
          ...
          <TabsContent value="calendar" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Planification et planning des campagnes
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
